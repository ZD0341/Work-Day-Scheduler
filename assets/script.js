...
$(function () {
    ...
    // The function below changes the color of each time block based on whether it's in the "past, present, or future"
    ...
    // The  function below will save the user's input to localStorage - only when the corresponding save button has been clicked.
    function textEntry() {
    ...
    // This will get the user input from the localStorage and set values for each time block.
    $('.time-block').each(function () {
